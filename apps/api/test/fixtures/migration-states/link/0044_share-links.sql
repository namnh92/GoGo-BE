...
CREATE TYPE share_link_type AS ENUM ('ROOM_INVITE', 'PLAN', 'PLACE', 'COLLECTION', 'REFERRAL');--> statement-breakpoint

CREATE TYPE share_link_provider AS ENUM ('NONE', 'TENJIN');--> statement-breakpoint
