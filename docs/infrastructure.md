...
| `place_provider_content_total`                   | `scope`, `tier`, `outcome`   | mỗi lần gọi biên ephemeral (#341): scope ngân sách, tier Details, 6 outcome đóng; không id, không nội dung Google |
